                    ...
                    <div className="space-x-2 flex-align-center">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                ...
                                />
                                <span
                                    className={`grid flex-shrink-0 rounded-full w-9 h-9 place-items-center sm:cursor-pointer ${showSearchBar
                                        ? 'hover:bg-slate-100 dark:hover:bg-hover-color-dark'
                                        : 'bg-primary text-white'
                                        }`}
                                    onClick={() => setShowSearchBar(!showSearchBar)}
                                >
                                    <BiSearch className="text-inherit" />
                                </span>
                            </div>
                        </form>
