    ...
    <div className="pt-10 pb-16">
      <div className="grid grid-cols-1 gap-16 sm:grid-cols-2 md:grid-cols-4">
        <div className="md:col-span-1">
          ...
          <p className="mt-3">
          Indulge in breathtaking views and meticulously crafted interiors, creating the ultimate urban retreat.
          </p>
          {/* <button className="mt-4 btn btn-primary">all categories</button> */}
          <a href="property-5"><button className="mt-4 btn btn-primary">all categories</button></a>
        </div>
